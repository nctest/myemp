...
public class MethodVO extends SuperVO {
	...
	private nc.vo.myemp.method.BasisVO[] bases;
	...
	/**
	 * 属性bases的Getter方法.属性名：分摊依据
	 * 创建日期:
	 * @return nc.vo.myemp.method.BasisVO[]
	 */
	public nc.vo.myemp.method.BasisVO[] getBases () {
		return bases;
	}   
	/**
	 * 属性bases的Setter方法.属性名：分摊依据
	 * 创建日期:
	 * @param newBases nc.vo.myemp.method.BasisVO[]
	 */
	public void setBases (nc.vo.myemp.method.BasisVO[] newBases ) {
	 	this.bases = newBases;
	} 	  
	/**
